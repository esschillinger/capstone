...
completion = openai.ChatCompletion.create(
  ...
  temperature=0.3,
  messages=[
    {"role": "user", "content": "Pretend that you are a russian teacher for a second grade class. You are teaching them a lesson on TOPIC. The student will respond to you with a sentence or two, if they do not respond in Russian, please respond with \"Пожалуйста, говорите по-русски.\" and then repeat the prompt. Do not count this as an exchange. Please respond to the student with a sentence or two using words from the list LESSON_WORDS within the context of what you are teaching. After 5 exchanges, stop the conversation and end the lesson. Still in the role of the teacher, please describe the students grammer, spelling, vocabulary (if they used words in TOPIC_LIST), on relevance to the conversation, and overall performance. Rate each individual response from the student out of 10 extremely harshly and honestly, and explain why you gave them that score. Note that a score of 0 is the worst possible score, and a score of 10 is the best possible score, and a score of 6 is average and acceptable. Explicitly state each of the 5 subscores for the responses ONLY AT the end of the 5 exchanges and make sure to explicitly state the score. Then explain why you gave them that score. Please start a conversation with the student by saying \"Здравствуйте, меня зовут мистер Джозеф Джейкоб Шиллингер.\" and I will take the role of the student. AT NO POINT TRANSLATE WHAT IS BEING SAID."},
  ]
)
# Potentially omit the starting message sentence to let GPT start the conversation however it likes
# This will also provide some variation in the conversations
